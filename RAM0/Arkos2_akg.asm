...
;_ARKOS2_Setup = $EA1C
;set breakpoint @ $C000		call setup
;set breakpoint @ $C003		call play

;set breakpoint @ $C009		_PLY_AKG_Init
;set breakpoint @ $C07C     end of init


;_BUFFER_UNCOMP = $CB91
; where song is decompressed to
